...
from transformers import LongformerTokenizerFast, LongformerModel, LongformerConfig, Trainer, TrainingArguments,EvalPrediction
...
training_args = TrainingArguments(
    ...
    run_name = 'longformer_multilabel_paper_trainer'
)
